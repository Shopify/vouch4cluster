module github.com/Shopify/vouch4cluster
...
require (
	...
	github.com/Shopify/voucher v0.0.0-20180928162150-38c7148dffda
	...
	github.com/opencontainers/image-spec v0.0.0-20180918080442-7b1e489870ac // indirect
